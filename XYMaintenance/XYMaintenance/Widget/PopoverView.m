...
// 边框颜色
#define kBorderColor [UIColor colorWithWhite:0 alpha:0.5]//UIColorFromRGB(0xE1E2E3)
...
- (UITableView *)tableView
{
    ...
    _tableView.separatorColor  = [UIColor whiteColor];//UIColorFromRGB(0xE1E2E3);
    _tableView.scrollEnabled   = NO;
    _tableView.backgroundColor = kBorderColor;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.contentView.backgroundColor = kBorderColor;
...
- (void)showFromView:(UIView *)aView selected:(PopoverBlock)selected
{
    ...
    _arrowView.frame     = CGRectMake(arrowCenterX-curX-kArrowW/2, 0, kArrowW, kArrowH); // 箭头高度 +1 遮挡住tableView的边框
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetFillColorWithColor(context, kBorderColor.CGColor);

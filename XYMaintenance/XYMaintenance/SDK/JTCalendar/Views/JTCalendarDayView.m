...
- (void)commonInit
{
    ...
    
    {
        ...
        _topLine.backgroundColor = XY_COLOR(210,218,228);
        _topLine.hidden = false;

        _topLine.layer.rasterizationScale = [UIScreen mainScreen].scale;
        _topLine.layer.shouldRasterize = YES;
    }
    ...
    
    {
        ...
        _textLabel.font = [UIFont systemFontOfSize:[UIFont systemFontSize]+3];
    }
...
//        
//        _subTextLabel.textColor = [UIColor blackColor];
//        _subTextLabel.textAlignment = NSTextAlignmentCenter;
//        _subTextLabel.font = [UIFont systemFontOfSize:[UIFont systemFontSize]-4];
//    }
...
- (void)layoutSubviews
{
    _topLine.frame = CGRectMake(0, 0, self.bounds.size.width, 1.0/[UIScreen mainScreen].scale);
   
    _textLabel.frame = CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height) ;
 
    //  _subTextLabel.frame = CGRectMake(0, self.bounds.size.height*2/3.0, self.bounds.size.width, self.bounds.size.height/4.0) ;
    
    CGFloat sizeCircle = MIN( self.bounds.size.width, self.bounds.size.height);

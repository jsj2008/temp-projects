...
//        dateFormatter.locale = _manager.dateHelper.calendar.locale;
        ...
        text = [NSString stringWithFormat:@"%ld 年 %ld 月",(long)comps.year,(long)currentMonthIndex];
        //text = [[dateFormatter standaloneMonthSymbols][currentMonthIndex - 1] capitalizedString];
    }
    
    [(UILabel *)menuItemView setFont:[UIFont systemFontOfSize:[UIFont systemFontSize]+3]];
    [(UILabel *)menuItemView setTextColor:RED_COLOR];

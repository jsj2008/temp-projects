...
- (XYRefreshLegendHeader*)addXYHeaderWithRefreshingTarget:(id)target refreshingAction:(SEL)action
{
    XYRefreshLegendHeader *header = [self addXYHeader];
    header.refreshingTarget = target;
    header.refreshingAction = action;
    header.dateKey = nil;
    return header;
...
- (XYRefreshLegendHeader *)addXYHeader
{
    XYRefreshLegendHeader *header = [[XYRefreshLegendHeader alloc] init];
    self.header = header;
    return header;
}
...
#pragma mark xyHeader
- (XYRefreshLegendHeader *)xyHeader
{
    if ([self.header isKindOfClass:[XYRefreshLegendHeader class]]) {
        return (XYRefreshLegendHeader *)self.header;
    }
    return nil;
}
